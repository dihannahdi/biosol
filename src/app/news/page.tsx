...
const caseStudies = articles;

const categories = ["Semua", "Biosekuriti Tanaman", "Kesehatan Hewan", "Akuakultur"];
...
export default function NewsPage() {
  ...
  const filteredStudies = useMemo(() => {
    if (activeCategory === "Semua") return caseStudies;
  ...
  return (
    <GSAPProvider>
      ...
      <main>
        ...
        <section
          ref={heroRef}
          className="relative pt-28 pb-12 sm:pt-32 sm:pb-16 lg:pt-40 lg:pb-20 bg-gradient-to-b from-carbon-950 to-carbon-900 text-white overflow-hidden"
        >
          ...
          <div className="relative container-wide">
            <div className="news-hero-content text-center max-w-3xl mx-auto px-2">
              ...
              <p className="text-base sm:text-lg text-carbon-400">
                Temukan bagaimana partner kami mencapai hasil luar biasa dengan solusi bioteknologi kami melalui studi kasus dan artikel terbaru.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-16 lg:py-24 bg-white">
          <div className="container-wide">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8 sm:mb-10">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-display font-bold text-carbon-900">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {featuredStudies.map((study, index) => (
                ...
                >
                  <Link href={`/news/${study.slug}`} className="block h-full">
                    <div
          ...
          <div className="container-wide">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {visibleStudies.length === 0 ? (
                <div className="col-span-full text-center py-12">
                  <p className="text-carbon-500">Tidak ada studi kasus dalam kategori ini.</p>
                </div>
              ) : (
                  ...
                  <Link href={`/news/${study.slug}`}>
                    ...
                    <div className="relative h-48 overflow-hidden">
                      {study.image ? (
                        ...
                        <div className="h-full bg-gradient-to-br from-forest-100 to-microbe-50" />
                      )}
                      <div className="absolute top-4 left-4">
                        <span className="px-3 py-1 bg-white/90 backdrop-blur-sm text-forest-700 text-sm font-medium rounded-full">
                          {study.category}
                        </span>
                      </div>
                    </div>
            ...
            {hasMoreStudies && (
              <div className="text-center mt-12">
                ...
                >
                  Muat Lebih Banyak ({filteredStudies.length - visibleCount} tersisa)
                </button>
              </div>
            )}
          </div>
